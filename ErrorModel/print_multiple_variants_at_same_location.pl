...
$previous_line=$line;
$total_tag_count= (split /,/, ((split /:/, $line_split[9])[1]))[0] + (split /,/, ((split /:/, $line_split[9])[1]))[1];
if($line_split[4] eq "A") {
   $A_variant=(split /,/, ((split /:/, $line_split[9])[1]))[1];
}
elsif($line_split[4] eq "T") {
   $T_variant=(split /,/, ((split /:/, $line_split[9])[1]))[1];
}
elsif($line_split[4] eq "G") {
   $G_variant=(split /,/, ((split /:/, $line_split[9])[1]))[1];
}
else {
   $C_variant=(split /,/, ((split /:/, $line_split[9])[1]))[1];
}
